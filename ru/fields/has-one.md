...
В данном примере вместо формы теперь будет [ActionButton](/docs/{{version}}/components/action-button.md), который вызывает [Modal](/docs/{{version}}/components/modal.md).
