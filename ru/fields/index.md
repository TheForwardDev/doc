...
Второй режим служит для отображения значения поля. При выводе поля через `TableBuilder`, нам не нужно его редактировать, мы просто хотим показать его содержимое.
